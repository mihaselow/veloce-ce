...
Requires **Rust 1.94+**. A single-node lab (self-signed TLS, file accounting) is documented end-to-end in **[docs/quickstart.md](docs/quickstart.md)**. Short version:
...
Security reports: [SECURITY.md](SECURITY.md). Commercial or alternative licensing: [hello@veloce-hpc.io](mailto:hello@veloce-hpc.io).
